...
@section('content')
    <div
        ...
        <form action="{{ route('leads.store') }}" method="POST" class="flex flex-col gap-5 text-black dark:text-slate-100">
            @csrf
            ...
            <div class="flex flex-col gap-1">
                ...
                <textarea name="notes" id="notes" rows="4"
                    class="p-2 border-2 border-black dark:border-white focus:outline-none focus:bg-slate-50 dark:focus:bg-slate-600 bg-white dark:bg-slate-700 text-black dark:text-white transition-colors">{{ old('notes') }}</textarea>
            </div>
            ...
            <div class="flex justify-end gap-3 mt-4 border-t-2 border-black dark:border-white pt-4">
                ...
                <button type="submit"
                    class="px-4 py-2 font-bold bg-[#93c5fd] text-black border-2 border-black dark:border-white shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] dark:shadow-[2px_2px_0px_0px_rgba(255,255,255,1)] hover:translate-y-[1px] hover:translate-x-[1px] hover:shadow-none dark:hover:shadow-none transition-all">
                    Simpan Lead
                </button>
            </div>
        </form>
