...
@section('content')
    <div
        ...
        <div
            class="p-4 border-b-2 border-black dark:border-white bg-[#93c5fd] flex justify-between items-center transition-colors">
            <h2 class="font-black text-xl text-black uppercase tracking-widest">Tambah Kartu Prospek</h2>
        </div>
        ...
        <div class="p-6">
            ...
            <form action="{{ route('leads.store') }}" method="POST"
                ...
                <div
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <select name="source" id="source"
                                ...
                                <option value="Google Ads" {{ old('source') == 'Google Ads' ? 'selected' : '' }}>Google Ads
                                </option>
                                <option value="Meta Ads" {{ old('source') == 'Meta Ads' ? 'selected' : '' }}>Meta Ads
                                </option>
                    ...
                    <div class="flex flex-col gap-1 mt-5">
                        ...
                        <textarea name="notes" id="notes" rows="4"
                            ...
                            class="p-2 border-2 border-black dark:border-white focus:outline-none focus:bg-white dark:focus:bg-slate-600 bg-white dark:bg-slate-700 text-black dark:text-white transition-colors">{{ old('notes') }}</textarea>
                    </div>
                </div>
                ...
                <div class="flex justify-end gap-4 mt-2">
                    ...
                    <button type="submit"
                        class="px-6 py-3 font-black uppercase tracking-wider bg-[#93c5fd] text-black border-2 border-black dark:border-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)] hover:translate-y-[2px] hover:translate-x-[2px] hover:shadow-none dark:hover:shadow-none transition-all">
                        + Simpan Ke Board
                    </button>
                </div>
            </form>
